...
import { PhoneCall, ArrowLeft, CheckCircle2, ArrowRight } from 'lucide-react'
      ...
      <main className="flex-1">
        <section className="bg-gradient-to-b from-blue-50 to-white py-20 dark:from-blue-950/20 dark:to-background">
          <div className="container mx-auto max-w-4xl px-6">
            <Link href="/#process" className="inline-flex items-center text-blue-600 hover:text-blue-700 mb-8">
            ...
            <div className="flex items-center mb-6">
              ...
              <h1 className="text-4xl font-bold tracking-tight">Discovery Call</h1>
            </div>
